...
Halotools ``v0.6`` will soon be available for installation with conda and pip. New features are summarized below. See the full changelog **CHANGES.rst** for details on smaller issues and bug-fixes. See :ref:`whats_new_v0x_history` for full release history information.
