...
#
dtype_consuelo_rockstar = np.dtype([
...
#
dtype_bolshoi_rockstar = np.dtype([
    ('halo_scale_factor', 'f4'), 
    ('halo_id', 'i8'), 
    ('halo_scale_factor_desc', 'f4'), 
    ('halo_id_desc', 'i8'), 
...
dtype_bolplanck_rockstar = dtype_bolshoi_rockstar
dtype_multidark_rockstar = dtype_bolshoi_rockstar
