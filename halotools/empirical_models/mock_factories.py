...
class MockFactory(object):
    ...
    """
    def __init__(self, galaxy_selection_func=None, **kwargs):
        """
        Parameters 
        ----------
        snapshot : object 
        ...
        galaxy_selection_func : function object, optional keyword argument 
            ...
            Function should take an Astropy table as input, and return a boolean numpy 
            array that will be treated as a mask over the table rows. If not None, 
        ...
        self.galaxy_selection_func = galaxy_selection_func
...
class HodMockFactory(MockFactory):
    ...
    def populate(self, **kwargs):
        ...
        if self.galaxy_selection_func is not None:
            mask = self.galaxy_selection_func(galaxy_table=self.galaxy_table)
