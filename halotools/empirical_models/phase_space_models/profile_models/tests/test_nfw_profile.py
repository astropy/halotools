...
def analytic_nfw_density_outer_shell_normalization(radii, conc):
    ...
    `~halotools.empirical_models.phase_space_models.profile_models.NFWProfile.mc_generate_nfw_radial_positions` 
...
class TestNFWProfile(TestCase):
    ...
    def test_mc_generate_nfw_radial_positions(self):
        """ Require that the points returned by the `~halotools.empirical_models.phase_space_models.profile_models.NFWProfile.mc_generate_nfw_radial_positions` function do indeed trace an NFW profile. 
