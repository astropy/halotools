...
#         rp_bins, period=period, weights1=ran_weights1, weights2=ran_weights1, weight_func_id=1)
...
#         rp_bins, period=None, weights1=ran_weights1, weights2=ran_weights1)
...
#         result = marked_npairs_3d(random_sample, random_sample, rp_bins, period=period,
...
#         rp_bins, period=period)

#     # wfunc = 1
#     weights = np.ones(Npts)*3
#     result = marked_npairs_3d(grid_points, grid_points, rp_bins, period=period,
