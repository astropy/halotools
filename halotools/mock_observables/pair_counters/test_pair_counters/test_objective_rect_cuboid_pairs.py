...
from ..objective_rect_cuboid_pairs import obj_wnpairs as wnpairs
...
def test_wnpairs_periodic():
    ...
    result = wnpairs(data1, data1, rbins, Lbox=Lbox, period=period, weights1=weights1, weights2=weights1, wfunc=1)
...
def test_wnpairs_nonperiodic():
    ...
    result = wnpairs(data1, data1, rbins, Lbox=Lbox, period=None, weights1=weights1, weights2=weights1, wfunc=1)
