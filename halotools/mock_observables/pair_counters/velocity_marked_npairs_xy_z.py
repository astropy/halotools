...
from .marked_pair_counting_engines import velocity_marked_npairs_xy_z_engine 
...
def velocity_marked_npairs_xy_z(data1, data2, rp_bins, pi_bins, period=None,
    ...
    weights1, weights2 = (
        _velocity_marked_npairs_xy_z_process_weights(data1, data2,
