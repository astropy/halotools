...
def fof_pairs(data1, data2, r_max, Lbox=None, period=None, verbose=False, num_threads=1):
    """
    Find all pairs wich have separations <= r_max
    ...
    engine = partial(_fof_pairs_engine, double_tree, r_max_squared, period, PBCs)
...
def _fof_pairs_engine(double_tree, r_max_squared, period, PBCs, icell1):
    """
...
def xy_z_fof_pairs(data1, data2, rp_max, pi_max, Lbox=None, period=None, verbose=False,\
                   num_threads=1):
    """
    Find all pairs wich have separations <= rp_max and <=pi_max
    ...
    #create a function to call with only one argument
    engine = partial(_xy_z_fof_pairs_engine, double_tree, rp_max_squared, pi_max_squared, period, PBCs)
...
def _xy_z_fof_pairs_engine(double_tree, rp_max_squared, pi_max_squared, period, PBCs, icell1):
    """
