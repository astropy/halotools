...
from .pair_counters.rect_cuboid_pairs import s_mu_npairs
##########################################################################################
...
def s_mu_tpcf(sample1, s_bins, mu_bins, sample2=None, randoms=None,\
    ...
    sample1, s_bins, mu_bins, sample2, randoms, period, do_auto, do_cross, num_threads,\
        _sample1_is_sample2, PBCs = _s_mu_tpcf_process_args(sample1, s_bins, mu_bins,\
                                    sample2, randoms, period, do_auto, do_cross,\
                                    estimator, num_threads, max_sample_size=int(1e6))
