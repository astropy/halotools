...
def enforce_sample_respects_pbcs(x, y, z, period):
    ...
    try:
        ...
        msg = (
            "You set periodic boundary conditions to be True by passing in \n"
    ...
    try:
        ...
        msg = (
            "You set xperiod = %.2f but there are values in the x-dimension \n"
    ...
    try:
        ...
        msg = (
            "You set yperiod = %.2f but there are values in the y-dimension \n"
            "of the input data that exceed this value"
        )
    ...
    try:
        ...
        msg = (
            "You set zperiod = %.2f but there are values in the z-dimension \n"
            "of the input data that exceed this value"
        )
...
def get_num_threads(input_num_threads, enforce_max_cores=False):
    ...
    if num_threads > num_available_cores:
        ...
        if enforce_max_cores is True:
            msg = (
                "Since ``enforce_max_cores`` is True,\n"
...
def get_period(period):
    ...
    if period is None:
        ...
        try:
            ...
            msg = (
                "Input ``period`` must be either a scalar or a 3-element sequence.\n"
...
def enforce_sample_has_correct_shape(sample, ndim=3):
    ...
    try:
        ...
        msg = (
            "Input sample of points must be a Numpy ndarray of shape (Npts, {0}).\n"
