...
def test_shape():
    ...
    # analytic randoms
    result_1 = ii_minus_3d(sample1, random_orientation1, random_ellipticities1, sample1,
         random_orientation1, random_ellipticities1, rbins, period=period, num_threads=1)

    assert np.shape(result_1) == (len(rbins)-1, )

    result_2 = ii_minus_3d(sample1, random_orientation1, random_ellipticities1, sample1,
         random_orientation1, random_ellipticities1, rbins, period=period, num_threads=1)
...
def test_threading():
    ...
    result_1 = ii_minus_3d(sample1, random_orientation, random_ellipticities, 
        sample1, random_orientation, random_ellipticities, rbins, period=period, num_threads=1)

    result_2 = ii_minus_3d(sample1, random_orientation, random_ellipticities, 
...
def test_round_result():
    ...
    # analytic randoms
    result_1 = ii_minus_3d(sample1, random_orientation_1, zero_ellipticities,
...
def test_random_result():
    ...
    result_1 = ii_minus_3d(sample1, random_orientation1, random_ellipticities1,
