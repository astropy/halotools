r"""
Module containing the `~halotools.mock_observables.w_gminus` function used to
...
def w_gminus(sample1, orientations1, ellipticities1, sample2, rp_bins, pi_max,
    ...
    Note in particular that the `~halotools.mock_observables.w_gminus` function does not
    ...
    >>> pi_max = 0.25
    >>> w = w_gminus(sample1, random_orientations, random_ellipticities, sample1, rp_bins, pi_max, period=Lbox)
