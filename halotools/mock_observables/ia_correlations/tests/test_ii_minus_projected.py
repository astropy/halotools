"""
Module providing unit-testing for the `~halotools.mock_observables.alignments.w_gminus` function.
"""
...
def test_w_minus_returned_shape():
    """
    ...
    # analytic randoms
    result_1 = ii_minus_projected(sample1, random_orientation, random_ellipticities, sample1,
        random_orientation, random_ellipticities, rp_bins, pi_max, period=period, num_threads=1)

    assert np.shape(result_1) == (len(rp_bins)-1, )

    result_2 = ii_minus_projected(sample1, random_orientation, random_ellipticities, sample1, 
...
def test_orientation_usage():
    ...
    # analytic randoms
    result_1 = ii_minus_projected(sample1, random_orientation_1, random_ellipticities, sample1,
        random_orientation_1, random_ellipticities, rp_bins, pi_max, period=period, num_threads=1, estimator='Natural')

    result_2 = ii_minus_projected(sample1, random_orientation_2, random_ellipticities, sample1,
...
def test_ellipticity_usage():
    ...
    # analytic randoms
    result_1 = ii_minus_projected(sample1, random_orientation, random_ellipticities_1, sample1,
        random_orientation, random_ellipticities_1, rp_bins, pi_max, period=period, num_threads=1, estimator='Natural')

    result_2 = ii_minus_projected(sample1, random_orientation, random_ellipticities_2, sample1,
...
def test_position_usage():
    ...
    result_2 = ii_minus_projected(sample2, random_orientation, random_ellipticities, sample1,
        random_orientation, random_ellipticities, rp_bins, pi_max, period=period, num_threads=1, estimator='Natural')
