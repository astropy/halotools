...
def test_inertia_tensor1():
    ...
    tensors, sum_of_masses = inertia_tensor_per_object(pos1, pos2, rsmooth, weights2=masses, period=Lbox)
...
def test_inertia_tensor2():
    ...
    tensors, sum_m_cython = inertia_tensor_per_object(pos1, pos2, rsmooth, weights2=masses, period=None)
...
def test_serial_parallel_agreement():
    ...
    tensors_serial, sum_m_serial = inertia_tensor_per_object(pos1, pos2, rsmooth, weights2=masses, num_threads=1)
    tensors_parallel, sum_m_parallel = inertia_tensor_per_object(pos1, pos2, rsmooth, weights2=masses, num_threads=2)
...
def test_pbcs():
    ...
    tensors1, sum_m_cython1 = inertia_tensor_per_object(pos1, pos2, rsmooth, weights2=masses, period=None)
    tensors2, sum_m_cython2 = inertia_tensor_per_object(pos1, pos2, rsmooth, weights2=masses, period=Lbox)
