...
def overhauled_cylindrical_isolation(sample1, sample2, rp_max, pi_max, period=None,
    num_threads=1, approx_cell1_size=None, approx_cell2_size=None):
    """
    Determine whether a set of points, ``sample1``, has a neighbor in ``sample2`` within 
    ...
    >>> rp_max = 0.05
    >>> pi_max = 0.1
    >>> is_isolated = overhauled_cylindrical_isolation(coords, coords, rp_max, pi_max, period=period)
    """
...
def overhauled_conditional_cylindrical_isolation(sample1, sample2, rp_max, pi_max,
                          marks1, marks2, cond_func, period=None, num_threads=1,
                          approx_cell1_size=None, approx_cell2_size=None):
    """
    ...
    >>> pi_max = 0.1
    >>> cond_func = 1
    >>> is_isolated = overhauled_conditional_cylindrical_isolation(coords, coords, rp_max, pi_max, marks, marks, cond_func, period=period)
    """
